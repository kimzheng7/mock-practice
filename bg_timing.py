...
instantly_say("Census is coming in 15 seconds. Prepare blasting.", 10)
instantly_say("Blast in 5.", 1)
instantly_say("4", 1)
instantly_say("3", 1)
instantly_say("2", 1)
instantly_say("1", 1)
...
# pre summer
instantly_say("Blast SB. PB is coming in 10 seconds, prepare quote.", 5)
instantly_say("Quote PB in 5.", 1)
instantly_say("4", 1)
instantly_say("3", 1)
instantly_say("2", 1)
instantly_say("1", 1)